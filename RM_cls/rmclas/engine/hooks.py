...
from rmclas.evaluation import flatten_results_dict
from rmclas.solver import optim
from rmclas.utils import comm
from rmclas.utils.checkpoint import PeriodicCheckpointer as _PeriodicCheckpointer
from rmclas.utils.events import EventStorage, EventWriter
from rmclas.utils.file_io import PathManager
from rmclas.utils.precision_bn import update_bn_stats, get_bn_modules
from rmclas.utils.timer import Timer
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    """
    Same as :class:`rmclas.utils.checkpoint.PeriodicCheckpointer`, but as a hook.
...
class AutogradProfiler(HookBase):
    ...
    def after_step(self):
        ...
        if "://" not in out_file:
            ...
            with tempfile.TemporaryDirectory(prefix="rmclas_profiler") as d:
